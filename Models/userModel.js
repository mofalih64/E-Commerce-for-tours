...
userSchema.methods.changedPasswordAfter = function (JWWTTimeStamp) {
  if (this.passwordChanedAt) {
    const changedTime = parseInt(this.passwordChanedAt.getTime() / 1000, 10);

    return JWWTTimeStamp < changedTime;
  }
  return false;
};
